...
Predicting vehicle CO2 emissions (g/km) from engine and fuel consumption specifications, using a regression model.

## Problem Statement

Given a vehicle's engine size, cylinder count, transmission, fuel type, and fuel consumption figures, predict its CO2 emissions in grams per kilometer. This is a **regression** problem.
...
<!-- TODO: fill in as you build this out -->
...
- Baseline model comparison (e.g. Linear Regression, Random Forest Regressor)
